window.onload = function () {
  ...
  moveDuck(duckDiv);
   ...
   duckDiv.addEventListener('click' , function(){
    ...
    setTimeout( function( ){duckDiv.remove(); checkForWinner();
...
//   setInterval(function() {
//     document.querySelector('.duck').classList.toggle("flap");}, 250); 
...
//   5. Congratulations! Move on to part 2!
  ...
  //     to see if there are any ducks left. (How can we check the DOM for more than one element?, and how can we see how 
  //many elements we get back) If not, alert "YOU WIN!"
